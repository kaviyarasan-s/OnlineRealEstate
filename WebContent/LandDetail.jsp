			...
			$.ajax({
				...
				success : function(responseText) {
					...
					if(value!=''){						
						...
						{
							$('#locality').append("<option value="+value[i]+">"+value[i+1]+"</option>");	
						}
					}
				}
			});
...
<body>
	<form method="post" action="ServletPostLand">
		...
		<table border="0" align="center" width="590px" height="800px">
			...
			<tr>
				<td> Description </td>
				<td> <textarea rows="4" cols="33" name="description"></textarea> </td>
			</tr>
			<tr>
				<td> <button type="submit" name="Enter">Submit</button>
			</tr>
			<tr> <td> &nbsp; </td> </tr>
			</table>
			<table>
			...
			<table>
				<tr> <td> <a href="ServletHome">Back</a></td> </tr>
			</table>
	</form>
</body>
</html>